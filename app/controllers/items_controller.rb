class ItemsController < ApplicationController
  ...
  private
  def item_params
    params.require(:item).permit(:name, :detail, :brand, :category_id, :price, :condition_id, :shipping_area_id, :shipping_days, :shipping_cost, images_attributes: [:src, :_destroy, :id])
  end
